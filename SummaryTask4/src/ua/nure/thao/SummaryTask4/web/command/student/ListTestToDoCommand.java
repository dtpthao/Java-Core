...
public class ListTestToDoCommand extends Command {

	private static final long serialVersionUID = 1754360828285357804L;
	
	private static final Logger LOG = Logger.getLogger(ListTestToDoCommand.class);
	...
	public String execute(HttpServletRequest request, HttpServletResponse response)
		...
		LOG.trace("Set the request attribute: sortByQuestions --> " + sortByQuestions);
		
		request.setAttribute("tests", tests);
		LOG.trace("Set the request attribute: tests --> " + tests.size());
		
		LOG.debug("Command finished");
		return Path.PAGE_STUDENT_LIST_TESTS;
	}
